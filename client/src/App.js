    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <g>
	<g>
		<path className="st0" d="M126.4,378H76.8c-17.8,0-32.2-14.5-32.2-32.2V164.6c0-17.8,14.4-32.2,32.2-32.2h46.4
...
<g>
	<g>
		<path className="st0" d="M148.9,82.3h135.2c-2.3,7.3-9.2,12.5-17.2,12.5H144.1c-9.9,0-18-8.1-18-18v-41c0-9.9,8.1-18,18-18H267
			c7.9,0,14.8,5.2,17.2,12.5H148.9c-6.1,0-11,4.9-11,11v30.2C137.9,77.4,142.8,82.3,148.9,82.3z"/>
	</g>
</g>
<path id="center" className="st0" d="M291.1,256c0,47.1-38.3,85.5-85.4,85.5c-47.1,0-85.4-38.3-85.4-85.5c0-47.1,38.3-85.4,85.4-85.4
	C252.7,170.6,291.1,208.9,291.1,256z"/>
<path className="st0" d="M205.8,142.4c-62.8,0-113.6,50.9-113.6,113.6c0,62.8,50.9,113.6,113.6,113.6S319.5,318.8,319.5,256
	...
	c56,0,101.4,45.4,101.4,101.4C307.1,312.1,261.6,357.5,205.6,357.5z"/>
        ...
        {isLoggedIn && (<MapContainer addLocation={this.addLocation} markers = {this.state.markers} lat={this.state.lat} lng={this.state.lng}/>)}
        {isLoggedIn && (<Carousel />)}
        {/* <Footer/> */}
